    ...
    <form action="" role="form" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-8">
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="form-group <?php echo e($errors->first('pro_name') ?'has-error' : ''); ?>"><label for="email">Tên sản phẩm</label>
        ...
        <div class="col-sm-12 clearfix">
            <div class="box-footer text-center">
                <a href="<?php echo e(route('admin.product.index')); ?>" class="btn btn-danger">Quay lại</a>
                <button type="submit" class="btn btn-primary"><?php echo e(isset($product) ?"Lưu" :"Lưu"); ?></button>
            </div>
    </form>
</div>
<script src="<?php echo e(asset('view/js/script.js')); ?>"></script>
<?php /**PATH D:\project\locnuoc2\resources\views/admin/product/form.blade.php ENDPATH**/ ?>