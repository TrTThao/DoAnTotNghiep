...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Từ khóa
                <small><a href="<?php echo e(route('admin.keyword.create')); ?>" class="btn btn-primary">Thêm mới</a></small>
            </h1>
            <ol class="breadcrumb">
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\locnuoc2\resources\views/admin/keyword/index.blade.php ENDPATH**/ ?>