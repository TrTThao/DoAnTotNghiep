...
<head>
    ...
    <!-- BOOTSTRAP INPUT -->
    <link rel="stylesheet" href="<?php echo e(asset('tagsinput/bootstrap-tagsinput-latest/src/bootstrap-tagsinput.css')); ?>">
    <!-- jquery-confirm -->
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="<?php echo e(asset('dist/img/user2-160x160.jpg')); ?>" class="img-circle"
                                     alt="User Image">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="">
                    <a href="<?php echo e(route('admin.keyword.index')); ?>">
                        <i class="fa fa-key"></i>
                        <span>Từ khóa</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="<?php echo e(route('admin.rating')); ?>">
...
<!--  BOOTSTRAP INPUT -->
<script src="<?php echo e(asset('tagsinput/bootstrap-tagsinput-latest/src/bootstrap-tagsinput.js')); ?>"></script>
<!-- jQuery UI 1.11.4 -->
...
<?php /**PATH D:\project\locnuoc2\resources\views/layout/admin.blade.php ENDPATH**/ ?>