...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Sản phẩm
                <small><a href="<?php echo e(route('admin.product.create')); ?>" class="btn btn-primary">Thêm mới</a></small>
            </h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            <table class="table">
                ...
                <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td><?php echo e($list->pro_name); ?><br><b>Danh mục:</b> <?php echo e($list->category->c_name); ?></td>
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\locnuoc2\resources\views/admin/product/index.blade.php ENDPATH**/ ?>