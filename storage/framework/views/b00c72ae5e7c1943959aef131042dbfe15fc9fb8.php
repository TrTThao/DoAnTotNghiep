            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-aqua">
                        <div class="inner">
                            <h3><?php echo e($totalTransaction); ?></h3>
                        ...
                        <a href="<?php echo e(route('admin.transaction.index')); ?>" class="small-box-footer">Xem thêm<i
                ...
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        ...
                        <a href="<?php echo e(route('admin.rating')); ?>" class="small-box-footer">Xem thêm<i
                                    class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-yellow">
                        ...
                        <a href="<?php echo e(route('admin.user.index')); ?>" class="small-box-footer">Xem thêm<i
                                    class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                    ...
                    <div class="box box-solid bg-teal-gradient">
                        ...
                        <div class="box-body border-radius-none">
                            ...
                            <figure class="highcharts-figure">
                                <div id="container2" data-json=<?php echo e($listDay); ?> data-money=<?php echo e($arrRevenueTransactionMonth); ?>

                                data-money-default=<?php echo e($arrRevenueTransactionMonthDefault); ?>></div>
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table class="table no-margin">
                                    ...
                                    <tbody>
                                    <?php $__currentLoopData = $hotProduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($value); ?></td>
                                            <td><?php echo e($list->id); ?></a></td>
                                            <td><?php echo e($list->pro_name); ?></td>
                                            <td><img src="<?php echo e($list->pro_avatar); ?>"
                                                     style="width:40px;height:40px;object-fit:contain"></td>
                                            <td style="text-align:center"><?php echo e($list->pro_pay); ?> lượt mua</td>
                                        </tr>
...
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\locnuoc2\resources\views/admin/index.blade.php ENDPATH**/ ?>